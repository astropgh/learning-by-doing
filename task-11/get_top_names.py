...
for i, data_line in enumerate(data_lines):
    ...
    if i % 2:
        ...
        if len(names) == 10:
            ...
            raise RuntimeError('There should be ten names per row. Take a look at your file, line:', data_line)
        ...
        try:
            ...
            raise RuntimeError('The text formatting is different than what recorder assumes. Take a look at your file, line:', data_line)
